...
open class MigrateMockData : DefaultTask() {
    ...
    companion object {
        ...
        private val endpointToResponseFileName = mapOf(
            ...
            "/rest/release-engineering/3/component/ReleaseManagementService/builds" to defaultParams + mapOf("branchNames" to "master") to "releng/builds-with-branch-filter-2.json",
